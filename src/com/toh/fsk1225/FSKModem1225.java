...
public class FSKModem1225 implements FSKDataInterface {
	...
	public boolean addDataReceiver(FSKModemListener1225 lsn) {
		return _recognizer.addDataReceiver(lsn);
	}

	public boolean removeDataReceiver(FSKModemListener1225 lsn) {
	...
	public static void debugPrint(FSKModem1225 fskm) {
		if (FSKConfig.logFlag) {
			final char NLC = '\n';
			final String SEP = "-----------------------------------------\n";
