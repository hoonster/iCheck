...
public class FSKModem315 implements FSKDataInterface {
	...
	public boolean addDataReceiver(FSKModemListener315 lsn) {
		return _recognizer.addDataReceiver(lsn);
	}

	public boolean removeDataReceiver(FSKModemListener315 lsn) {
	...
	public static void debugPrint(FSKModem315 fskm) {
		if (FSKConfig.logFlag) {
			final char NLC = '\n';
			final String SEP = "-----------------------------------------\n";
