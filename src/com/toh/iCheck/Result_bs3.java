...
public class Result_bs3 extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.result_bs3);

		// videoView = (VideoView) findViewById(R.id.videoViewbs3);
		...
		final ImageView i = (ImageView) findViewById(R.id.img3);

		if (name.equals(female)) {
			i.setBackgroundResource(R.drawable.anim2);
		} else {
			i.setBackgroundResource(R.drawable.animmale2);
		}
		...
		TextView tv = ((TextView) findViewById(R.id.bacValuebs3));
		tv.setText(getIntent().getStringExtra("bacValue"));

		TextView tv1 = ((TextView) findViewById(R.id.resultbs3_r0));
		tv1.setText(getIntent().getStringExtra("r_0"));
		sharedFact = tv1.getText().toString();

		TextView tv2 = ((TextView) findViewById(R.id.resultbs3_r2));
		tv2.setText(getIntent().getStringExtra("r_2"));
		sharedFact1 = tv2.getText().toString();

		TextView tv3 = ((TextView) findViewById(R.id.resultbs3_r8));
		...
		Button butGene = (Button) findViewById(R.id.testAgainbs3);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (resultCode == RESULT_OK) {
			Intent refresh = new Intent(this, Result_bs3.class);
