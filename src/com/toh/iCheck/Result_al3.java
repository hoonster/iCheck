...
public class Result_al3 extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.result_al3);
		...
		TextView tv = ((TextView) findViewById(R.id.bacValue3));
		tv.setText(getIntent().getStringExtra("bacValue"));
		
		TextView tv1 = ((TextView) findViewById(R.id.resultAl3_r0));
		tv1.setText(getIntent().getStringExtra("r_0"));
		sharedFact = tv1.getText().toString();
		
		TextView tv2 = ((TextView) findViewById(R.id.resultAl3_r2));
		tv2.setText(getIntent().getStringExtra("r_2"));
		sharedFact1 = tv2.getText().toString();
		
		TextView tv3 = ((TextView) findViewById(R.id.resultAl3_r8));
		...
		Button butGene = (Button) findViewById(R.id.testAgain3);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (resultCode == RESULT_OK) {
			Intent refresh = new Intent(this, Result_al3.class);
