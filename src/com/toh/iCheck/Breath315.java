...
public class Breath315 extends Activity {
	...
	public static final int REQUEST_CODE_RESULT_BS1 = 1004;
	public static final int REQUEST_CODE_RESULT_BS2 = 1005;
	public static final int REQUEST_CODE_RESULT_BS3 = 1006;
	public static final int REQUEST_CODE_RESULT_BS4 = 1007;
	public static final int REQUEST_CODE_RESULT_BS5 = 1008;
	...
	public int myNum, myNum1, myNum2;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.breath315);
		...
		volume = am.getStreamVolume(AudioManager.STREAM_MUSIC); // volumeAº 0~15

		am.setStreamVolume(AudioManager.STREAM_MUSIC, 20,
				AudioManager.FLAG_PLAY_SOUND);

		// am.setStreamVolume(AudioManager.STREAM_MUSIC,
		// am.getStreamMaxVolume(AudioManager.STREAM_MUSIC), 0);// ≫cAI¾i¾ß
		// // CO
		...
		String s22 = new String("SHV-E160");
		...
		// TextView tv1 = (TextView) findViewById(R.id.textViewbs);
		// tv1.setText("μI¹øA°ÆaAIAoAO´I´U.");
		Uri video = Uri.parse("android.resource://" + getPackageName()
				+ "/raw/smoke");
		videoView = (VideoView) findViewById(R.id.videoViewbs);
		...
		TextView tv1 = ((TextView) findViewById(R.id.somedatabs));
		tv1.setText(getIntent().getStringExtra("someDatabs"));
		String shared = tv1.getText().toString();
		TextView tv2 = ((TextView) findViewById(R.id.somedatabs1));
		tv2.setText(getIntent().getStringExtra("someDatabs1"));
		String shared1 = tv2.getText().toString();
		TextView tv3 = ((TextView) findViewById(R.id.somedatabs2));
		tv3.setText(getIntent().getStringExtra("someDatabs2"));
		...
		pw_two = (ProgressWheel) findViewById(R.id.progressBarTwo1);
		// textView = (TextView) findViewById(R.id.textViewbs6);
				...
				public void dataReceivedFromFSKModem(final byte[] data) {
					runOnUiThread(new Runnable() {
						public void run() {
							...
							TextView recvView = (TextView) findViewById(R.id.textViewbs);
							TextView recvView2 = (TextView) findViewById(R.id.textViewbs4);
							recvView.setText("R");
	...
	public void result() {
		...
		progressDialog2 = new ProgressDialog(Breath315.this, R.style.MyTheme);
	...
	public void view_result() {
		...
		vibe.vibrate(1000);
		recvView3 = (TextView) findViewById(R.id.textViewbs2);
		...
		if (bac1 < 0.02) {
			...
			Intent intent = new Intent(Breath315.this, Result_bs1.class);
			...
			startActivityForResult(intent, REQUEST_CODE_RESULT_BS1);
			setResult(RESULT_OK, null);
			finish();
		} else if (bac1 >= 0.02 && bac1 < 0.05) {
			System.out.println("BAC is :" + bac1);
			Intent intent = new Intent(Breath315.this, Result_bs2.class);
			intent.putExtra("bacValue", BAC_NUM);
			intent.putExtra("r_0", Integer.toString(r_0));
			intent.putExtra("r_2", Integer.toString(r_2));
			intent.putExtra("r_8", Integer.toString(r_8));

			startActivityForResult(intent, REQUEST_CODE_RESULT_BS2);
			setResult(RESULT_OK, null);
			finish();
		} else if (bac1 >= 0.05 && bac1 < 0.1) {
			System.out.println("BAC is :" + bac1);
			Intent intent = new Intent(Breath315.this, Result_bs3.class);
			intent.putExtra("bacValue", BAC_NUM);
			intent.putExtra("r_0", Integer.toString(r_0));
			intent.putExtra("r_2", Integer.toString(r_2));
			intent.putExtra("r_8", Integer.toString(r_8));

			startActivityForResult(intent, REQUEST_CODE_RESULT_BS3);
			setResult(RESULT_OK, null);
			finish();
		} else if (bac1 >= 0.1 && bac1 < 0.2) {
			System.out.println("BAC is :" + bac1);
			Intent intent = new Intent(Breath315.this, Result_bs4.class);
			intent.putExtra("bacValue", BAC_NUM);
			intent.putExtra("r_0", Integer.toString(r_0));
			intent.putExtra("r_2", Integer.toString(r_2));
			intent.putExtra("r_8", Integer.toString(r_8));

			startActivityForResult(intent, REQUEST_CODE_RESULT_BS4);
			setResult(RESULT_OK, null);
			finish();
		} else if (bac1 >= 0.2) {
			System.out.println("BAC is :" + bac1);
			Intent intent = new Intent(Breath315.this, Result_bs5.class);
			intent.putExtra("bacValue", BAC_NUM);
			intent.putExtra("r_0", Integer.toString(r_0));
			intent.putExtra("r_2", Integer.toString(r_2));
			intent.putExtra("r_8", Integer.toString(r_8));

			startActivityForResult(intent, REQUEST_CODE_RESULT_BS5);
			setResult(RESULT_OK, null);
			finish();
		}
	}
