...
public class Result_bs1 extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.result_bs1);

		// videoView = (VideoView) findViewById(R.id.videoViewbs1);
		...
		final ImageView i = (ImageView) findViewById(R.id.img1);

		if (name.equals(female)) {
			i.setBackgroundResource(R.drawable.anim);
		} else {
			i.setBackgroundResource(R.drawable.animmale);
		}
		...
		TextView tv = ((TextView) findViewById(R.id.bacValuebs1));
		tv.setText(getIntent().getStringExtra("bacValue"));

		TextView tv1 = ((TextView) findViewById(R.id.resultbs1_r0));
		tv1.setText(getIntent().getStringExtra("r_0"));
		sharedFact = tv1.getText().toString();

		TextView tv2 = ((TextView) findViewById(R.id.resultbs1_r2));
		tv2.setText(getIntent().getStringExtra("r_2"));
		sharedFact1 = tv2.getText().toString();

		TextView tv3 = ((TextView) findViewById(R.id.resultbs1_r8));
		...
		Button butGene = (Button) findViewById(R.id.testAgainbs1);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (resultCode == RESULT_OK) {
			Intent refresh = new Intent(this, Result_bs1.class);
